...
{
  wp_enqueue_style('bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css', 5.0, 'all');
  wp_enqueue_style('style', get_stylesheet_uri(), array('bootstrap'), 1.0,  'all');
  if (is_singular() && comments_open() && get_option('thread_comments')) {
    wp_enqueue_script('custom-comment-reply', get_template_directory_uri() . "/js/custom-comment-reply.js", array('jquery'), 1.0, true);
  }
}
