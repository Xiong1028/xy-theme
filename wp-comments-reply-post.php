...
$email            = isset($_POST['email']) ? esc_attr(isset($_POST['email'])) : $user->user_email;
$author           = isset($_POST['author']) ? isset($_POST['author']) : $user->display_name;
...
$comment_ID = wp_insert_post($data);
